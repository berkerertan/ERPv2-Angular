...
export const routes: Routes = [
    ...
    },
    {
        ...
        loadComponent: () => import('./features/legal/legal-document.component').then(m => m.LegalDocumentComponent),
        data: { legalKey: 'privacy' },
        title: 'Gizlilik Politikasý | StokNet'
    },
    {
        path: 'kullanim-kosullari',
        loadComponent: () => import('./features/legal/legal-document.component').then(m => m.LegalDocumentComponent),
        data: { legalKey: 'terms' },
        title: 'Kullaným Koþullarý | StokNet'
    },
    {
        path: 'cerez-politikasi',
        loadComponent: () => import('./features/legal/legal-document.component').then(m => m.LegalDocumentComponent),
        data: { legalKey: 'cookies' },
        title: 'Çerez Politikasý | StokNet'
    },
    {
        path: 'auth/register',
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loadComponent: () => import('./features/supplier-quotes/supplier-quotes.component').then(m => m.SupplierQuotesComponent)
            },
            {
                path: 'companies',
            ...
            {
                path: 'collection-plans',
                loadComponent: () => import('./features/collection-plans/collection-plans.component').then(m => m.CollectionPlansComponent)
            },
            {
                path: 'checks-bills',
